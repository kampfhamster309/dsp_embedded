...
* always create tests for newly implemented logic
* update documentation (README.md and everything in a "doc" directory if that directory exists) if logic or features have changed
* if there are any actions pending, which require human action (installing certain software, make certain decisions, setup specialized testing environments,...) write those into a human_to_do.md file
